...
var _token_NV = require("./token_NV");
...
function initModels(sequelize) {
  ...
  var token_NV = _token_NV(sequelize, DataTypes);
  ...
  token_NV.belongsTo(nhanvien, { as: "MANV_nhanvien", foreignKey: "MANV"});
  nhanvien.hasMany(token_NV, { as: "token_NVs", foreignKey: "MANV"});
